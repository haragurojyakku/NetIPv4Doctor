...
> **この機能は、作者の常駐アプリ DeskAssistant（非公開）にも取り込まれています。**
> ここと同じ判定・修復手順を Python へ移植したものが「ネットワーク」タブに入っており、
> 普段使いはそちら（自動監視・トレイからのワンクリック診断が付きます）です。
> このリポジトリは、単体で持ち出せる版として残しているものです。
